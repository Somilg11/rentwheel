...
export default function VehiclesSection() {
  ...
  const handleAddVehicle = async () => {
    try {
      ...
      await apiService.addVehicle({
        ...newVehicle,
        seats: parseInt(newVehicle.seats, 10) || 0,
        pricePerDay: parseFloat(newVehicle.pricePerDay) || 0,
      });
  ...
  const handleEditVehicle = async () => {
    ...
    try {
      await apiService.updateVehicle(currentVehicle.id, {
        ...currentVehicle,
        seats: parseInt(currentVehicle.seats, 10) || 0,
        pricePerDay: parseFloat(currentVehicle.pricePerDay) || 0,
      });
